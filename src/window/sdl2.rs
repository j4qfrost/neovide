...
impl WindowHelper {
    ...
    pub fn toggle_fullscreen(&mut self, window: &mut Window) {
    ...
    pub fn synchronize_settings(&mut self, mut window: Window) -> Window {
        ...
        if window.fullscreen_state() != fullscreen_state {
            ...
            self.toggle_fullscreen(&mut window);
        }
        window
    }
...
pub fn ui_loop() {
    ...
    loop {
        ...
        sdl_window = window_helper.synchronize_settings(sdl_window);
